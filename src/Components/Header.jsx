    ...
    <>
      ...
      <div
        className={`fixed top-8 left-0 right-0 z-50 transition-all duration-300 ${
          isScrolled ? "bg-[#0D1B2A] text-white" : "bg-white text-black"
        }`}
      >
        <div className="mx-[10%] flex justify-between items-center h-20">
          ...
          <div className="flex items-center hidden lg:flex">
            <ul className="list-none flex space-x-4">
              <li className="hover:text-btColor cursor-pointer">
                <Link to="/" className=" hover:text-btColor">
                  Home
                </Link>
              </li>
              <li className="hover:text-btColor cursor-pointer">
                <Link to="About" className=" hover:text-btColor">
                  About
                </Link>
              </li>
              <li className="hover:text-btColor cursor-pointer">
                <Link to="services" className=" hover:text-btColor">
                  Services
                </Link>
              </li>
              <li className="hover:text-btColor cursor-pointer">
                <Link to="contact" className=" hover:text-btColor">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div className="mx-5 flex space-x-4 hidden lg:flex">
            <button
              ...
              className="px-6 py-2 text-btColor border-btColor border rounded-md hover:bg-btColor hover:text-white transition-all"
            >
              Login
            </button>
            <button
              onClick={openRegisterModal}
              className="px-6 py-2 text-white bg-btColor border-btColor border rounded-md hover:bg-white hover:text-btColor transition-all"
            >
              Register
            </button>
          </div>
        ...
        >
          <div className="p-4 flex justify-between items-center">
            ...
            <button onClick={toggleSidebar} className="text-btColor">
              ✖
            </button>
          </div>
          <ul className="list-none">
            <li
              className="p-4 text-black hover:bg-gray-200 cursor-pointer"
              onClick={toggleSidebar}
            >
              <Link to="/">Home</Link>
            </li>
          ...
          <div className="flex flex-col items-center mt-4">
            <button
              onClick={openLoginModal}
              className="px-4 py-2 text-btColor border-btColor border rounded-md hover:bg-btColor hover:text-white transition-all mb-2"
            >
              Login
            </button>
            <button
              onClick={openRegisterModal}
              className="px-4 py-2 text-white bg-btColor border-btColor border rounded-md hover:bg-white hover:text-btColor transition-all"
            >
              Register
            </button>
          </div>
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 bg-gray-100">
            ...
            <div className="flex justify-center space-x-4">
              ...
              >
                <FaYoutube
                  className="text-btColor hover:text-blue-600 transition-colors"
                  size={24}
                />
              </a>
              <a
