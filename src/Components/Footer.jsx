...
import { FaArrowRight, FaFacebook, FaTwitter, FaLinkedin, FaYoutube } from 'react-icons/fa';
        ...
        <div>
          ...
          <ul>
            <li className="mb-2 flex items-center">
              <FaArrowRight className="mr-2" /> About
            </li>
            <li className="mb-2 flex items-center">
              <FaArrowRight className="mr-2" /> Our Team
            </li>
            <li className="mb-2 flex items-center">
              <FaArrowRight className="mr-2" /> Contact
            </li>
            <li className="mb-2 flex items-center">
              <FaArrowRight className="mr-2" /> Careers
            </li>
          </ul>
        </div>
